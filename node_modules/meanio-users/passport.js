...
module.exports = function(passport) {
  ...
  passport.use(new FacebookStrategy({
      clientID: config.strategies.linkedin.clientID,
      clientSecret: config.strategies.linkedin.clientSecret,
  ...
  passport.use(new FitbitStrategy({
      clientID: config.strategies.fitbit.clientID,
      clientSecret: config.strategies.fitbit.clientSecret,
      callbackURL: config.strategies.fitbit.callbackURL
    },
    function(accessToken, refreshToken, profile, done) {
      User.findOne({
      ...
      user.save(function(err) {
        if (err) {
          console.log(err);
          return done(null, false, {message: 'FitBit login failed, email already used by other login strategy'});
        } else {
          return done(err, user);
        }
      });
